# Based on https://github.com/ChesterYue/ohmyzsh-theme-passion
# Ref: https://www.linkedin.com/pulse/making-custom-zsh-theme-fun-aesthetic-md-mohibur-rahman/
...
function directory() {
    ...
    # Ref: https://www.reddit.com/r/zsh/comments/tvmmvp/comment/i3a7rw9/?utm_source=share&utm_medium=web2x&context=3
    local directory="%-40<…<%~%<<";
    local color_reset="%{$reset_color%}";
